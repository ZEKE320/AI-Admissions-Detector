...
from transformers import BertModel, DistilBertModel, PretrainedConfig, PreTrainedModel
...
class MyConfigDistilBert(PretrainedConfig):
...
class MyHFModel_DistilBertBased(PreTrainedModel):
    config_class = MyConfigDistilBert
